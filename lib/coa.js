...
module.exports = require('coa').Cmd()
    ...
    .opt()
        ...
        .end()
    .opt()
        .name('sourceMap').title('Generate source map')
        .long('source-map')
        .flag()
        .end()
    .opt()
    ...
    .act(function(opts) {
        ...
        if (opts.sourceMap && opts.output == process.stdout) {
            console.warn('Could not generated source map without output specified');
