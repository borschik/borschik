        ...
        File: exports.File = INHERIT({
            ...
            parse: function(content) {
                ...
                var cache = this.tech.cache,
                    ...
                    parsedContent = cache.getParsedContent(filename);

                if (parsedContent) {
                    return parsedContent;
                }

                parsedContent = this.childType == 'include'?
                    this.parseInclude(content) : this.parseLink(content);

                cache.putParsedContent(filename, parsedContent);
