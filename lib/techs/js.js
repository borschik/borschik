...
exports.Tech = base.Tech.inherit({
    process: function() {
        ...
        if (opts.minimize) {
            if (sourceMap) {
                var uglifyOptions = opts.techOptions.uglify || (opts.techOptions.uglify = {});
    ...
    File: exports.File = base.File.inherit({
        ...
        processInclude: function(baseFile, content) {
            ...
            var serializer = new NodesSerializer(parsed, {
                ...
                outputSourceMapRoot: techOpts.techOptions.outputSourceMapRoot,
                outputSourceMapFilename: techOpts.techOptions.outputSourceMapFilename || techOpts.output.path
            });
