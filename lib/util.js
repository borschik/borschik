...
exports.writeFile = function(output, res) {
    ...
    if (typeof output === 'string') {
        return fs.writeFile(output, res);
    }
...
exports.buildSourceMapURLComment = function buildSourceMapURLComment(options) {
    const url = options.inline
        ? 'data:application/json;base64,' + Buffer.from(options.inline).toString('base64')
        :  options.url;
