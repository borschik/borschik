...
describe('js-include:', function() {
    ...
    const TESTS = [
        ...
        {name: 'should joins borshik:include with expression as "/*" before', file: 'include5.js'},
        {name: 'should joins borshik:include with expression as "//"" before', file: 'include6.js'}
    ];
